...
//
//template <typename Token>
//typename ir<Token>::dag_key_type ir<Token>::build_dag_key(const typename ir<Token>::parse_tree_type& tree)
//{
//    dag_key_type result;
//
...
//
//template <typename Token>
//typename ir<Token>::parse_dag_type ir<Token>::find_dag(const typename ir<Token>::dag_key_type& key,
//                                                                               const typename ir<Token>::dag_cache_type& cache)
//{
...
//
//template <typename Token>
//void ir<Token>::ast_to_asd(const typename ir<Token>::parse_tree_type& ast, typename ir<Token>::parse_dag_type& result_asd)
//{
//    // collect nodes
//
